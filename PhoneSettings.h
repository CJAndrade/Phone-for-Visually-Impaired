...
#define CALL_NUMBER2 "+1XXXXXXXXXX"// Number to call when button 2 is pressed
...
#define MESSAGE_TEXT1 "Call the Landline" //Modify the text in the message 1
#define MESSAGE_TEXT2 "Call Home please" //modify the text in the message 2
